...
<a id="aud1_play" href="/#" onclick="(function(evt) { aud1.play(); aud1.muted=false; evt.target.innerHTML='Now Playing'; evt.target.onclick = null; }) (event || window.event)">Listen</a>
&nbsp;<br /><br />
<!--a href="http://www.w3.org/2010/05/video/mediaevents.html" target="_blank">Media Help</a-->
<audio id=aud1" alt="Listen to A Strategic Vision By John Hall"  controls="true" preload="auto" muted="true" style="width:280px;">
