...
if (!require(akima) || !require(magick)  || !require(png)  || !require(rgl) || !require(reshape2) || !require(viridis)) {
  install.packages(c("akima", "devtools", "ggplot2", "magick", "png", "reshape2", "viridis"))
...
if (file.exists(paste0(working_dir, "/content/data/65-Elevation_DEMHF0p7m2016_N5117E267.img"))) {
    localdem <- paste0(working_dir, "/content/data/65-Elevation_DEMHF0p7m2016_N5117E267.img")
} else {
